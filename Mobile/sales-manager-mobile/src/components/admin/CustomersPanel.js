...
const styles = StyleSheet.create({
  ...
  badgeText: { fontFamily: fonts.adminBodySemiBold, fontSize: 10, color: admin.textMuted },
  meta: { fontFamily: fonts.adminBody, fontSize: 12, color: admin.textMuted, marginTop: 2 },

...
const styles = StyleSheet.create({
  ...
  loaderText: { fontFamily: fonts.adminBody, fontSize: 13, color: admin.textMuted, marginTop: 10 },
  ...
  itemName: { flex: 1, fontFamily: fonts.adminBody, fontSize: 13.5, color: '#475569' },
  itemNameUnread: {
    fontFamily: fonts.adminBodyBold,
    fontSize: 14,
    color: '#0f172a',
  },
  itemTime: { fontFamily: fonts.adminBody, fontSize: 11, color: '#94a3b8' },
  itemTimeUnread: { fontFamily: fonts.adminBodySemiBold, color: '#475569' },
  itemSub: { fontFamily: fonts.adminBody, fontSize: 12.5, color: '#64748b' },

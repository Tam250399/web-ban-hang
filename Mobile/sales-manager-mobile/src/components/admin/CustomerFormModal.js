...
const styles = StyleSheet.create({
  ...
  closeBtnText: { color: admin.text, fontSize: 14 },
  body: { padding: 16, gap: 14 },
  toggleRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: admin.card, borderWidth: 1, borderColor: admin.border, borderRadius: 8, padding: 12,
  },
  toggleLabel: { fontFamily: fonts.adminBodySemiBold, fontSize: 14, color: admin.text },
  field: { gap: 6 },
  ...
  errorText: { fontFamily: fonts.adminBody, fontSize: 12.5, color: admin.dangerText },

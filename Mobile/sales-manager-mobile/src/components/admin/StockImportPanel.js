...
const styles = StyleSheet.create({
  ...
  name: { flex: 1, fontFamily: fonts.adminBodySemiBold, fontSize: 13.5, color: admin.text },
  total: { fontFamily: fonts.adminDisplayBold, fontSize: 13, color: admin.text },
  meta: { fontFamily: fonts.adminBody, fontSize: 11.5, color: admin.textMuted },
  note: { fontFamily: fonts.adminBody, fontSize: 11.5, color: admin.textMuted, marginTop: 2, fontStyle: 'italic' },
  ...
  actionText: { fontFamily: fonts.adminBodySemiBold, fontSize: 11, color: admin.text },

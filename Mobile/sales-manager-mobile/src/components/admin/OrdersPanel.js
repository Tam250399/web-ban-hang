...
const styles = StyleSheet.create({
  ...
  filterRow: { marginTop: 10, flexGrow: 0, flexShrink: 0, height: 40 },
  filterRowContent: { gap: 6, paddingHorizontal: 16 },
  filterChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, backgroundColor: admin.card, borderWidth: 1, borderColor: admin.border },
  filterChipActive: { backgroundColor: admin.primary, borderColor: admin.primary },
  filterChipText: { fontFamily: fonts.adminBodySemiBold, fontSize: 11.5, color: admin.textMuted },

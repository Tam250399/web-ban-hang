    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasData(
                    new Product { Id = 1, ProductCode = "XM001", ProductName = "Xi măng Hà Tiên PC40", Unit = "Bao 50kg", Price = 95000, StockQuantity = 500, Category = "Xi măng", CategoryId = 1, UnitTypeId = 1, Description = "Xi măng Portland PC40", CreatedAt = new DateTime(2024, 1, 1) },
                    new Product { Id = 2, ProductCode = "GT001", ProductName = "Gạch thẻ đặc 6x10x22", Unit = "Viên", Price = 2500, StockQuantity = 10000, Category = "Gạch", CategoryId = 2, UnitTypeId = 2, Description = "Gạch đất nung tiêu chuẩn", CreatedAt = new DateTime(2024, 1, 1) },
                    new Product { Id = 3, ProductCode = "CT001", ProductName = "Cát vàng xây dựng", Unit = "m³", Price = 250000, StockQuantity = 200, Category = "Cát - Đá", CategoryId = 3, UnitTypeId = 3, Description = "Cát vàng sạch", CreatedAt = new DateTime(2024, 1, 1) },
                    new Product { Id = 4, ProductCode = "ST001", ProductName = "Sắt thép tròn phi 10", Unit = "Kg", Price = 17500, StockQuantity = 1500, Category = "Thép", CategoryId = 4, UnitTypeId = 4, Description = "Thép tròn xây dựng phi 10mm", CreatedAt = new DateTime(2024, 1, 1) },
                    new Product { Id = 5, ProductCode = "TN001", ProductName = "Tôn lạnh mạ kẽm 0.4mm", Unit = "m²", Price = 85000, StockQuantity = 800, Category = "Tôn - Mái", CategoryId = 5, UnitTypeId = 5, Description = "Tôn mạ kẽm dày 0.4mm", CreatedAt = new DateTime(2024, 1, 1) },
                    new Product { Id = 6, ProductCode = "CX001", ProductName = "Cửa sắt hộp 2 cánh 1.2x2m", Unit = "Bộ", Price = 1800000, StockQuantity = 50, Category = "Cửa - Khung", CategoryId = 6, UnitTypeId = 6, Description = "Cửa sắt hộp sơn tĩnh điện", CreatedAt = new DateTime(2024, 1, 1) },
